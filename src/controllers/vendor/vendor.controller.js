...
exports.AddVendor = async (req, res) => {
    try {
        ...
        logger.log("info", "Vendor added successfully!");
        return res.status(statusCodes.OK).send({data: result, message: 'Vendor added successfully!'});
    } catch (error) {
        logger.log("error", `Error in adding vendor:: ${error.message}`);
...
exports.GetAllVendors = async (req, res) => {
    try {
        ...
        logger.log("info", "Vendors fetched successfully!");
        return res.status(statusCodes.OK).send({
            message: 'Vendors fetched successfully!',
            data: result
        });
    } catch (error) {
        logger.log("error", `Error in fetching vendors:: ${error.message}`);
        return res.status(statusCodes.INTERNAL_SERVER_ERROR).send({
...
exports.GetVendorById = async (req, res) => {
    try {
        ...
        logger.log("info", "Vendor fetched successfully!");
        return res.status(statusCodes.OK).send({
            message: 'Vendor fetched successfully!',
            data: result
        });
    } catch (error) {
        logger.log("error", `Error in fetch vendor:: ${error.message}`);
        return res.status(statusCodes.INTERNAL_SERVER_ERROR).send({
